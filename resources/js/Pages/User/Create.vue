    ...
    <q-page padding>
        ...
        <q-form class="zcard q-pa-md" @reset="resetForm" @submit="handleSubmit">
            <div class="row q-col-gutter-sm">
                ...
                <div class="col-xs-12 col-sm-6">
                    <q-select v-model="form.district_id" multiple use-chips :options="districts" option-value="id"
                        option-label="name" emit-value map-options label="Assign Districts" />

                </div>
                <div class="col-xs-12 col-sm-6">
                    <q-select v-model="form.roles" multiple use-chips :options="roles" dense class="my-input"
                        label="Roles" outlined :option-value="'id'" :option-label="'name'"
                        :error="form.errors.hasOwnProperty('roles')" :error-message="form.errors?.roles?.toString()"
                        @blur="delete form.errors['roles']" :rules="[
                ...
                <div class="col-xs-12 col-sm-6">
                    <q-input v-model="form.password_confirmation" type="password" class="my-input" dense
                        ...
                        @blur="delete form.errors['password_confirmation']" :rules="[
