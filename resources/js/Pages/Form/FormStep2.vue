            ...
            <q-page padding>
                <div class="flex flex-col justify-center items-center gap-6">
                    ...
                    <div
                        ...
                        <img id="background" class="w-[369px] h-[88px]"
                        ...
                        <q-form @submit.prevent="submitForm" class="q-gutter-md">
                            <div class="q-mb-sm">
                                ...
                                <div>
                                    ...
                                    <q-select dense outlined="" v-model.number="form.source_district"  label="Select Source District"
                    ...
                    <q-input
                        outlined
                        placeholder="Ruang phurh tanna tur District awmna"
                        dense
                        class="custom-input"
                    ...
                    />
                            ...
                            <div>
                                <div>
                                    ...
                                    <q-input outlined placeholder="Ruang chhuah veng" dense class="custom-input"
                            ...
                            <div>
                                <div>
                                    ...
                                    <q-input outlined placeholder="Ruang Zalhna tur District awmna" dense
                                        class="custom-input" v-model="form.destination_district" />
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <q-input outlined dense v-model="form.distance" label="Distance (in km)" required />
                            </div>
                            ...
                            <div>
                                ...
                                <q-input outlined placeholder="Ruang phurhna motor hming" dense class="custom-input"
                            ...
                            <div>
                                ...
                                <q-input outlined placeholder="Motor neitu/khalhtu biak pawh theihna tur" dense
                                    class="custom-input" v-model="form.driver_phone" maxlength="10"  :rules="[
