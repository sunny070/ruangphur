        ...
        <q-page-container>
            <q-page padding>
                <div class="flex flex-col justify-center items-center gap-6">
                    ...
                    <div
                        class="border w-[412px] h-[1200px] rounded-[10px] p-[23px]"
                    >
                        <q-form
                        ...
                        >
                            ...
                            <div class="pt-5">
                                ...
                                <q-select
                                    ...
                                    dense
                                    outlined
                                    v-model.number="form.destination_district"
                        ...
                        <q-card-section>
                            <div class="flex gap-4 mb-4">
                                <q-input
                                    ...
                                    class="flex-grow"
                                    @update:model-value="
                                        debouncedSearch($event, 'source')
                                    "
                                />
                                <q-btn
                                    icon="gps_fixed"
                                    @click="locateUser('source')"
                                />
                            </div>
                            <div
                                class="autocomplete-list"
                                v-if="sourcePredictions.length"
                            >
                                <q-list bordered>
                                    <q-item
                                        v-for="prediction in sourcePredictions"
                        ...
                        <q-card-section>
                            <div class="flex gap-4 mb-4">
                                <q-input
                                    ...
                                    class="flex-grow"
                                    @update:model-value="
                                        debouncedSearch($event, 'destination')
                                    "
                                />
                                <q-btn
                                    icon="gps_fixed"
                                    @click="locateUser('destination')"
                                />
                            </div>
                            <div
                                class="autocomplete-list"
                                v-if="destinationPredictions.length"
                            >
                                <q-list bordered>
                                    <q-item
                                        v-for="prediction in destinationPredictions"
                                        :key="prediction.place_id"
                                        clickable
                                        @click="
                                            selectPrediction(
                ...
                <q-dialog v-model="preview">
                    <q-card class="w-[411px] h-[900px] rounded-t-lg">
                        ...
                        <q-card-actions class="ml-[22px] pt-[35px]">
                            ...
                            />
                            <q-btn
                                style="padding: 10px 60px; border-radius: 12px"
                                label="Approve & Next"
                                color="black"
                                @click="submitForm"
                            />
    ...
    distanceMatrixService.value.getDistanceMatrix(
        ...
        (response, status) => {
            ...
            if (
                ...
                $q.notify({
                    message:
                        "Could not calculate route. Please check locations.",
                    color: "negative",
                });
            }
        }
